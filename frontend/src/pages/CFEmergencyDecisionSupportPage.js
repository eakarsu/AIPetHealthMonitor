...
// Custom Feature: Emergency decision support
// Emergency decision support: Real-time assessment of emergency severity; AI routes to 24-hr clinic vs. wait for morning vet appointment vs. poison control
import React, { useState } from 'react';

export default function CFEmergencyDecisionSupportPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-emergency-decision-support/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Emergency decision support</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Emergency decision support: Real-time assessment of emergency severity; AI routes to 24-hr clinic vs. wait for morning vet appointment vs. poison control</p>
